    ...
    <div className="w-full mb-12">
      <div className="relative w-full rounded-3xl md:rounded-[40px] overflow-hidden shadow-xl md:shadow-2xl min-h-[250px] sm:min-h-[350px] md:min-h-[500px] flex items-center group cursor-pointer border border-white/10 glass-panel">
        ...
        <div className="relative z-10 p-5 sm:p-8 md:p-16 md:w-2/3 flex flex-col justify-center space-y-3 sm:space-y-6">
          ...
          <h1 className="text-4xl leading-[0.9] sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tighter text-white uppercase">
            THE KING <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-yellow-200 to-orange-400 pr-4 pb-1 inline-block">OF POP</span>
          </h1>
          <p className="text-gray-400 text-xs sm:text-base md:text-lg max-w-md font-medium leading-relaxed">
